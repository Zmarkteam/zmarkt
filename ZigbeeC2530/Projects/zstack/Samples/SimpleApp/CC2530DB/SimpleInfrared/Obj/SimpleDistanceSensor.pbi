...
xMT_SAPI_CB_FUNC
-lC
H:\3gbox\zigbee\zigbee综合应用演示代码\cc2530 综合实验 z-stack 2.4.0-1.4.0\Projects\zstack\Samples\SimpleApp\CC2530DB\SimpleInfrared\List\
-lA
H:\3gbox\zigbee\zigbee综合应用演示代码\cc2530 综合实验 z-stack 2.4.0-1.4.0\Projects\zstack\Samples\SimpleApp\CC2530DB\SimpleInfrared\List\
--diag_suppress
Pe001,Pa010
-o
H:\3gbox\zigbee\zigbee综合应用演示代码\cc2530 综合实验 z-stack 2.4.0-1.4.0\Projects\zstack\Samples\SimpleApp\CC2530DB\SimpleInfrared\Obj\
-e
--require_prototypes
--no_code_motion
--debug
